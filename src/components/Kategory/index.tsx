...
//         <h1 className="text-3xl font-bold my-11">Категории</h1>
        ...
        //       <img className="w-[300px] h-[200px] object-cover contrast-50 duration-500 bg-gradient-to-bl via-orange-900 to-indigo-600  hover:contrast-100" src={el.url} alt="" />
        //        </div>
        //      </div>
        //      </div>
